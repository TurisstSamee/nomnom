...
document.addEventListener("DOMContentLoaded", function () {
    ...
    generateBtn.addEventListener("click", function () {
        ...
        if (age < 18) {
            result += "<p>Khách hàng chưa đủ tuổi.</p>";
        } else if (age <= 35) {
            result += "<p>Đối tượng trẻ, nội dung sống động.</p>";
        } else {
            result += "<p>Đối tượng trưởng thành, nội dung dài.</p>";
        }

        if (goal === "engagement") {
            result += "<p>Tăng tương tác: Video ngắn.</p>";
        } else if (goal === "education") {
            result += "<p>Giáo dục: Video dài.</p>";
        } else {
            result += "<p>Tăng doanh thu: Hình ảnh đẹp, quảng cáo.</p>";
        }
